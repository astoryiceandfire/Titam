...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // , serverUrl: URL + "jsp/controller.jsp"
          , serverUrl: 'http://10.1.1.222:8585/TitanGameCMS/upload/uploadImg'
        ...
        //     // 'source' ,'|' ,'undo' ,'redo', '|','bold' 'italic', 'underline',  'strikethrough', '|', 'superscript', 'subscript', '|', 'forecolor', 'backcolor', 'insertorderedlist', '|', 'removeformat', '|',
