...
<!-- table -->
           <el-table :data="tableData" border style="width: 100%">
            <el-table-column prop="awardId"label="礼包道具ID" width="80">
            </el-table-column>
            <el-table-column prop="pname" label="道具名称" width="100">
            </el-table-column>
             
             <el-table-column prop="propsId1" label="道具ID1" width="100">
            </el-table-column>
            <el-table-column prop="propsCount1" label="数量1" width="100">
            </el-table-column>
             <el-table-column prop="propsId2" label="道具ID2" width="80">
            </el-table-column>
            <el-table-column prop="propsCount2" label="数量2" width="80">
            </el-table-column>
             <el-table-column prop="propsId3" label="道具ID3" width="80">
            </el-table-column>
            <el-table-column prop="propsCount3" label="数量3" width="80">
            </el-table-column>
             <el-table-column prop="propsId4" label="道具ID4" width="80">
            </el-table-column>
            <el-table-column prop="propsCount4" label="数量4" width="80">
            </el-table-column>
             <el-table-column prop="propsId5" label="道具ID5" width="80">
            </el-table-column>
            <el-table-column prop="propsCount5" label="数量5" width="80">
            </el-table-column>
