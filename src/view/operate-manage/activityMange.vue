...
<!-- table -->
   <el-table :data="tableData" border style="width: 100%"  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="activeId" label="活动ID" width="120">
        </el-table-column>
         
         <el-table-column prop="activeTitle" label="活动标题" width="120">
        </el-table-column>
         <el-table-column prop="xactiveType" label="活动类型" width="120">
        </el-table-column>
         <el-table-column prop="xshelveTime" label="上架时间" width="180">
        </el-table-column>
         <el-table-column prop="xunshelveTime" label="下架时间" width="180">
        </el-table-column>
