<template>
  <div class="propMange-wrapper">
          ...
          <nav>
              ...
              <div class="nav-item">
              <label for="">道具ID:</label>
              <el-input v-model="searchBaseOption.pid" size="small" placeholder=""></el-input>
            </div>  
            <div class="nav-item">
              <label for="">道具名称:</label>
              <el-input v-model="searchBaseOption.pname" size="small" placeholder=""></el-input> 
            </div>  
              <div class="nav-item">
              ...
              <div class="nav-item">
              <label for="">道具品质:</label>
             
               <el-select v-model="searchBaseOption.propGrade" placeholder="请选择道具品质">
                                 <el-option
              ...
              <div class="nav-item">
              <label for="">道具类型:</label>
             
               <el-select v-model="searchBaseOption.ptype" placeholder="请选择道具类型">
                                <el-option
              ...
              <el-select v-model="searchBaseOption.isAstrict" placeholder="请选择使用限制">
                                <el-option
          ...
          <div class="nav-item">
            ...
            <!-- table -->
               <el-table :data="tablepropbase" border style="width: 100%">
                    <el-table-column prop="pid" label="道具ID" width="100">
                    </el-table-column>
                     
                     <el-table-column prop="pname" label="道具名称" width="200">
                    </el-table-column>
                     <el-table-column prop="xgameType" label="道具所属游戏" width="200">
                    </el-table-column>
                     <el-table-column prop="propGrade" label="道具品质" width="150">
                    </el-table-column>
                      <el-table-column prop="xptype" label="道具类型" width="150">
                    </el-table-column>
                      <el-table-column prop="xisDeposit" label="存入背包" width="100">
                    </el-table-column>
