...
<!-- table -->
           <el-table :data="tableData" border style="width: 100%">
            <el-table-column  prop="pid" label="道具ID" width="120">
            </el-table-column>
            <el-table-column prop="pname" label="道具名称" width="100">
            </el-table-column>
             
             <el-table-column prop="describeProp" label="道具描述" width="150">
            </el-table-column>
             <el-table-column label="icon资源" width="150">
               <template scope="scope">
                        <img v-if="scope.row.iconPicture" :src="scope.row.iconPicture" class="avatar">
                </template>
            </el-table-column>
               <el-table-column prop="xaddTime" label="创建时间" width="180">
              </el-table-column>
               <el-table-column prop="xupdTime" label="修改时间" width="180">
              </el-table-column>
