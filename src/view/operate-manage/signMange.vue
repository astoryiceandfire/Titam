...
<!-- table -->
   <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="id" label="奖励ID" width="120">
        </el-table-column>
         <el-table-column prop="xdays" label="对应天数" width="120">
        </el-table-column>
         <el-table-column prop="xastrict" label="双倍限制" width="120">
        </el-table-column>
         <el-table-column prop="pid" label="奖励道具" width="120">
        </el-table-column>

         <el-table-column prop="pcount" label="道具数量" width="120">
          </el-table-column>
