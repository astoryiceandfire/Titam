<template>
  ...
  <nav>     
        <div class="nav-item">
             <el-button type="primary" size="small" @click="dialogAddpage=true,form.id=''">添加页面</el-button>
...
<!-- table -->
   <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="id" label="页面ID" width="120">
         ...
         <el-table-column prop="updtime" label="修改时间" width="120">
        </el-table-column>
...
<!--   //添加签到奖励 -->
    <el-dialog title="添加页面" v-model="dialogAddpage" size="mini" :modal-append-to-body = false>
      <div class="content">
        <div class="header">
        <el-form ref="form"  :model="form"  label-width="200px">
         <!--  <el-form-item label="页面id" >
            ...
            <el-form-item label="请选择页面显示类型">
              <el-col :span="14">
                <el-radio-group v-model="form.layout">
                    <el-radio label="1">一条广告显示</el-radio>
                  <el-radio label="2">二条广告显示</el-radio>
                   <el-radio label="3">三条广告显示</el-radio>
                    <el-radio label="4">四条广告显示</el-radio>
                </el-radio-group>
                </el-col>
              </el-form-item>
...
export default{
    ...
    beforeRouteLeave (to, from, next) {
      ...
      methods:{
         ...
         // deleteAction(){
         //    let option = {}
         //    option.ids = [11,12,13,8]
         //    this.API.ApideleteUi(option).then((res)=>{})
         // },
         handleGag(index,row){
