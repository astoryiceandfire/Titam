  ...
  <div class="vipMange-wrapper">
      <el-tabs v-model="activeName">
          <el-tab-pane label="VIP基础属性" name="first">
            <!-- table -->
               <el-table :data="tableDatabase" border style="width: 100%">
                    <el-table-column prop="buyMoney" label="VIP购买费用(¥)" width="200">
                    </el-table-column>
                     
                     <el-table-column prop="renewMoney" label="VIP续约费用(¥)" width="200">
                    </el-table-column>
                     <el-table-column prop="continueDay" label="持续时间(天)" width="120">
                    </el-table-column>
                     <el-table-column prop="experience" label="每日经验扣减" width="200">
                    </el-table-column>
