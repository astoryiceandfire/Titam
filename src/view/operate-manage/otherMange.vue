  ...
  <div class="otherMange-wrapper">
      <el-tabs v-model="activeName">
          ...
          <div class="nav-item">
            ...
            <!-- table -->
               <el-table :data="tableword" border style="width: 100%">
                    <el-table-column prop="id" label="ID" width="150">
                    </el-table-column>
                     
                     <el-table-column prop="sensitiveWord" label="敏感字" width="200">
                    </el-table-column>
...
<!-- table -->
           <el-table :data="tableData" border style="width: 100%">
            <el-table-column prop="tipsId" label="提示ID" width="80">
            </el-table-column>
            <el-table-column prop="xtipsType" label="提示类型" width="80">
            </el-table-column>
             <el-table-column prop="tipsCount" label="按钮数量" width="80">
            </el-table-column>
             <el-table-column prop="hintContent" label="提示内容" width="80">
            </el-table-column>
