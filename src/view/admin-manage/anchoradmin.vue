<template>
  <div class="admin-wrapper">
    <zs-tip :tiptext='tipName'></zs-tip>
       ...
       <el-button size="small"  type="primary" class="addadmin" @click='addAnchorRole'>添加</el-button>
    <!-- 导航栏 -->
...
<!-- 上导航栏 -->
     ...
     <!-- 分页 -->
<!--   //添加用户 -->
    <el-dialog :title="isAddUser?'添加角色':'修改'" v-model="dialogVisible" :rules="rules"  size="tiny" :modal-append-to-body = false>
